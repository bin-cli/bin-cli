...
markdownBlocks.push(`<!--`)
markdownBlocks.push(`\n\n\n\n`)
markdownBlocks.push(`${stars}\n${stars}\n${stars}`)
markdownBlocks.push(`    This file was automatically generated.`)
markdownBlocks.push(`    DO NOT EDIT IT DIRECTLY.`)
markdownBlocks.push(`    You should edit the source in the features/ directory instead.`)
markdownBlocks.push(`    See CONTRIBUTING.md for more details.`)
markdownBlocks.push(`${stars}\n${stars}\n${stars}`)
markdownBlocks.push(`\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n`)
markdownBlocks.push(`-->`);
